      ...
      <div className="relative z-10 p-5">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="bg-black/40 rounded-lg p-3 border border-purple-500/20">
            <h3 className="text-purple-300 font-semibold mb-2 text-xs uppercase tracking-wide">
              {t("help.navigation")}
            </h3>
            <ul className="space-y-1 text-gray-300">
              <li>
                • <span className="text-purple-200">{t("help.clickNodes")}</span>{" "}
                {t("help.clickNodesToNavigate")}
              </li>
              <li>
                • <span className="text-purple-200">{t("help.scrollPinch")}</span>{" "}
                {t("help.scrollPinchToZoom")}
              </li>
              <li>
                • <span className="text-purple-200">{t("help.dragBackground")}</span>{" "}
                {t("help.dragBackgroundToPan")}
              </li>
            </ul>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {EDGE_COLORS.map((edge) => (
                <div key={edge.labelKey} className="flex items-center gap-2">
                  <div className="w-3 h-0.5 rounded-full" style={{ backgroundColor: edge.color }} />
          ...
          <div className="bg-black/40 rounded-lg p-3 border border-purple-500/20">
            <h3 className="text-purple-300 font-semibold mb-2 text-xs uppercase tracking-wide">
              {t("help.graphStructure")}
            </h3>
            <ul className="space-y-1 text-gray-300">
              <li>
                • <span className="text-yellow-300">{t("help.centerNode")}</span>:{" "}
                {t("help.centerNodeDesc")}
              </li>
              <li>
                • <span className="text-blue-300">{t("help.leftNodes")}</span>:{" "}
                {t("help.leftNodesDesc")}
              </li>
              <li>
                • <span className="text-green-300">{t("help.rightNodes")}</span>:{" "}
                {t("help.rightNodesDesc")}
              </li>
            </ul>
          </div>
        </div>
