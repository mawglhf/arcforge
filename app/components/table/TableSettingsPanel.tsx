...
export default function GraphSettingsPanel({
  ...
  const EDGE_TYPES = [
    ...
    {
      id: "repair",
      labelKey: "graph.repair",
      color: "#ef4444",
      bgColor: "rgba(239, 68, 68, 0.15)",
    },
    {
      id: "recycle",
      labelKey: "graph.recycle",
      color: "#34d399",
      bgColor: "rgba(52, 211, 153, 0.15)",
    },
    {
      id: "salvage",
      labelKey: "graph.salvage",
      color: "#10b981",
      bgColor: "rgba(16, 185, 129, 0.15)",
    },
    {
      id: "upgrade",
      labelKey: "graph.upgrade",
      color: "#ec4899",
            ...
            <div className="grid grid-cols-3 gap-2">
              {EDGE_TYPES.map((edgeType) => (
                <button
                  ...
                  style={{
                    backgroundColor: selectedEdgeTypes.has(edgeType.id)
                      ? edgeType.bgColor
                      : "rgba(0,0,0,0.4)",
                    borderColor: selectedEdgeTypes.has(edgeType.id)
                      ? edgeType.color
                      : "rgba(139, 92, 246, 0.2)",
